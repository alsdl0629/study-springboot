...
import com.example.socketcommunication.global.exception.ExpiredTokenException;
import com.example.socketcommunication.global.exception.InvalidTokenException;
import com.example.socketcommunication.global.security.auth.AuthDetailsService;
...
public class JwtTokenProvider {
    ...
    public User validate(String token) {
        return userRepository.findByEmail(getTokenSubject(token)).get();
    }
